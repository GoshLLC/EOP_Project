                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(in_array(auth()->user()->role, ['staff','admin','volunteer'])): ?>
                        ...
                        <select class="form-control mb-3" name="vaccine_status">
                            ...
                            <option value="expired">Not Up to Date</option>
                        </select>
                    ...
                    <div class="col-6">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->role === 'admin'): ?>
                                <a href="<?php echo e(route('animals.edit', $row->id)); ?>" class="btn btn-warning btn-sm d-inline-flex gap-2 mt-2">
                                    Edit
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->role === 'admin'): ?>
                                <form action="<?php echo e(route('animals.destroy', $row->id)); ?>"
                                    ...
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button class="btn btn-danger btn-sm d-inline-flex gap-2 mt-2">
                                        Delete
                                    </button>
                                </form>
                            <?php endif; ?>
